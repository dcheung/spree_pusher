...
module Spree
  module Pusher
    class OrderSerializer < ActiveModel::Serializer
      ...
      has_many :line_items,  serializer: Spree::Pusher::LineItemSerializer
      has_many :payments, serializer: Spree::Pusher::PaymentSerializer

      has_one :shipping_address, serializer: Spree::Pusher::AddressSerializer
      has_one :billing_address, serializer: Spree::Pusher::AddressSerializer
